				...
				<div class="listbox">
					<div class="list">
						<a onclick="location.href='details.jsp'" class="name">
							<img src="./img/gibon.jpg" class="photo"><br>클래식 버거</a>
					</div>
					<div class="list">
						<a onclick="location.href='details.jsp'" class="name">
							<img src="./img/bulgogi.jpg" class="photo"><br>불고기 버거</a>
					</div>
					<div class="list">
						<a onclick="location.href='details.jsp'" class="name">
							<img src="./img/cheese.jpg" class="photo"><br>치즈 버거</a>
					</div>
				</div>
				<div class="listbox">
					<div class="list">
						<a onclick="location.href='details.jsp'" class="name">
							<img src="./img/chiken.jpg" class="photo"><br>치킨 버거</a>
					</div>
					<div class="list">
						<a onclick="location.href='details.jsp'" class="name">
							<img src="./img/bacon.jpg" class="photo"><br>베이컨 버거</a>
					</div>
					<div class="list">
						<a onclick="location.href='details.jsp'" class="name">
							<img src="./img/shrimp.jpg" class="photo"><br>새우버거</a>
					</div>
				</div>
			</div>
			<div class="listrow">
